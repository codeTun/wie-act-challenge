          ...
          <div className="lg:flex">
            ...
            <div className="lg:w-1/2 bg-gradient-to-t from-purple-600 to-pink-500 p-8 lg:p-12">
              ...
              <p className="text-white mb-8">
                Our pursuit of excellence extends to building strong
                relationships and meaningful interactions with our users and
                business partners. Have a question or need assistance?
